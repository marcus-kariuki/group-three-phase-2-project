...
const Player = () => {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(`https://dimba-api.herokuapp.com/players/${id}`)
    ...
    return (
      <>
        ...
        <div className="col-md-6 text-white">
          ...
          <h3 className="display-6 my-4 fw-bold">${player.value}</h3>
  ...
  return (
    <div>
      <div className="container py-5">
        <div className="row py-4">{loading ? <Loading /> : <ShowPlayer />}</div>
      </div>
    </div>
  );
};
